...
- `python quickex.py tagger rename-tag [OLD TAG] [NEW TAG]`: Finds all the occurrences of the specified tag in all the initiatives and replace it with the new name.
